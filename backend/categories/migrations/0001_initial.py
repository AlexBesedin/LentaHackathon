    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uom', models.IntegerField(choices=[('штука', 'Штука'), ('вес', 'Вес')], validators=[django.core.validators.MinValueValidator(0)], verbose_name='маркер, обозначающий продаётся товар на вес или в ШТ')),
