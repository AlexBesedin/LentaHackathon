...
urlpatterns = [
    ...
    path('forecast/bookmarks_add/<int:forecast_id>/', AddToBookmarksView.as_view(), name='add_to_bookmarks'),
    path('forecast/bookmarks_remove/<int:bookmark_id>/', RemoveFromBookmarksView.as_view(), name='remove_from_bookmarks'),
    path('forecast/bookmarks/', UserBookmarksView.as_view(), name='user_bookmarks'),
    ...
    path('sales/bookmarks_add/<int:sales_id>/', AddToSalesBookmarksView.as_view(), name='add_to_salesbookmarks'),
    path('sales/bookmarks_remove/<int:salesbookmark_id>/', RemoveFromSalesBookmarksView.as_view(), name='remove_from_salesbookmarks'),
    path('sales/bookmarks/', UserSalesBookmarksView.as_view(), name='user_salesbookmarks'),
]
